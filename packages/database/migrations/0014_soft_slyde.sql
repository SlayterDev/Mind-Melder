...
ALTER TABLE "settings" DROP COLUMN IF EXISTS "notifications_check_interval";--> statement-breakpoint
ALTER TABLE "settings" DROP COLUMN IF EXISTS "notifications_reminder_minutes";--> statement-breakpoint
ALTER TABLE "settings" DROP COLUMN IF EXISTS "notifications_show_upcoming";